...
public class GDFReader {
	 ...
	 */
	public static void inputGraph(final Graph g, final InputStream gdfis, NovoClass aux){
		GDFReader.inputGraph(g, gdfis, 1000, "\"", null, aux);
	}
	 ...
	 */
	public static void inputGraph(final Graph g, final InputStream gdfis, int buf, NovoClass aux){
		GDFReader.inputGraph(g, gdfis, buf, "\"", null, aux);
	}
	...
	public static void inputGraph(final Graph g,
			final InputStream gdfis, int buf, String eidp, NovoClass aux){
		GDFReader.inputGraph(g, gdfis, buf, "\"", eidp, aux);
	}
	 ...
	 */
	public static void inputGraph(final Graph g,
			InputStream gdfis, String quote, String eidp, NovoClass aux){
		GDFReader.inputGraph(g, gdfis, 1000, quote, eidp, aux);
	...
	public static void inputGraph(final Graph g, final InputStream gdfis,
			int buf, String quote, String eidp, NovoClass aux){
